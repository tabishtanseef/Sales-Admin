! function(t, n) {
    ...
    function l(t, n, e) {
        ...
        if (null !== o) {
            var a = function(n) {
                ! function(t) {
                    return (t.startsWith("on") ? t.toLowerCase() : "on".concat(t)) in window
                }(n) ? r.setAttribute(n, o[n]): r.addEventListener(n, function(t) {
                    o[n](t, r)
                })
            };
            for (var c in o) a(c)
    ...
    var u = function() {
            function n(t) {
                i(this, n), (this.options = t).title && t.content && (c(t.title) && (this.title = t.title), this.useInnerHTML = !0 === t.useInnerHTML, c(t.content) && (this.content = t.content), t.animation && ("boolean" == typeof t.animation || c(t.animation)) ? this.animation = t.animation : this.animation = "fade", this.port = null, this.template = this.createBase())
            }
            return s(n, [{
                key: "createBase",
                value: function() {
                ...
                key: "render",
                value: function(t) {
                    var n = 0 < arguments.length && void 0 !== t ? t : document.body;
                    this.options.beforeRender && this.options.beforeRender(this), n.appendChild(this.template), this.options.afterRender && this.options.afterRender(this), "fade" === this.animation && function(n, e) {
                        var i = 0;
                ...
                value: function() {
                    var t = this;
                    this.options.beforeClose && this.options.beforeClose(this), this.animation ? "fade" === this.animation && function(n, e) {
                        var i = 100;
                        window.requestAnimationFrame(function t() {
