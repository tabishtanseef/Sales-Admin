...
if (isset($_POST['go'])) {
	...
	if(!$error){
		header ("location:contact_person_list.php?state=$state&city=$city&school=$school&salesman=$salesman");
	}
}
function person($run_attendance){
	$n=1;
    ...
    <div class="wrapper">
        ...
        <div id="content">
			...
			if(isset($salesman) && isset($city) && isset($state) && isset($school)){
				echo "<h4>&nbsp;&nbsp;&nbsp;&nbsp; Contact Person List of $salesman in $school of $state - $city</h4>";
			}
			else if(isset($salesman) && isset($school) && isset($state)){
			echo "<h4>&nbsp;&nbsp;&nbsp;&nbsp; Contact Person List of $salesman in $school of $state</h4>";
			}
			else if(isset($city) && isset($school) && isset($state)){
			echo "<h4>&nbsp;&nbsp;&nbsp;&nbsp; Contact Person List in $school of $state - $city</h4>";
			}
			else if(isset($city) && isset($salesman) && isset($state)){
			echo "<h4>&nbsp;&nbsp;&nbsp;&nbsp; Contact Person List of $salesman of $state - $city</h4>";
			}
			else if(isset($city) && isset($state)){
			echo "<h4>&nbsp;&nbsp;&nbsp;&nbsp; Contact Person List of $state - $city</h4>";
			}
			else if(isset($school) && isset($state)){
			echo "<h4>&nbsp;&nbsp;&nbsp;&nbsp; Contact Person List of $school in $state</h4>";
			}
			else if(isset($salesman) && isset($state)){
			echo "<h4>&nbsp;&nbsp;&nbsp;&nbsp; Contact Person List of $salesman in $state</h4>";
			}
			else if(isset($state)){
			echo "<h4>&nbsp;&nbsp;&nbsp;&nbsp; Contact Person List of $state</h4>";
			}
			?>
			...
			<div class="row sub" style="margin-top:2%;">
				<div class="col-sm-12 horizontal-scroll">
					<table id="school_list" class="table table-hover table-responsive w-100 d-block d-md-table" style="width:100%;">
						...
						$get_attendance="select * from contact_person_list where user_name ='$salesman' AND school_state = '$state' and school_city='$city' and school_name='$school' order by p_name";
						$run_attendance= mysqli_query($conn, $get_attendance);
						 
						person($run_attendance);
						}
						else if(isset($salesman) && isset($state) && isset($school)){
						
						$get_attendance="select * from contact_person_list where user_name ='$salesman' AND school_state = '$state' and school_name='$school' order by p_name";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from contact_person_list where school_city ='$city' AND school_state = '$state' and user_name='$salesman' order by p_name";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from contact_person_list where school_city ='$city' AND school_state = '$state' and school_name='$school' order by p_name";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from contact_person_list where school_state = '$state' AND school_city='$city' order by p_name";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from contact_person_list where school_name ='$school' AND school_state = '$state' order by p_name";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from contact_person_list where user_name ='$salesman' AND school_state = '$state' order by p_name";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from contact_person_list where school_state = '$state' order by p_name";
						$run_attendance= mysqli_query($conn, $get_attendance);
						 
						person($run_attendance);
						}
						else{
						$get_attendance="select * from contact_person_list order by p_name";
						$run_attendance= mysqli_query($conn, $get_attendance);
