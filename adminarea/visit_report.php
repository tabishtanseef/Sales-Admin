...
if (isset($_POST['go'])) {
	...
	if(!$error){
		header ("location:visit_report.php?state=$state&city=$city&school=$school&salesman=$salesman&start_date=$start_date&end_date=$end_date");
	}
}
...
function visit($run_attendance) {
    ...
    while($row_attendance=mysqli_fetch_array($run_attendance))
	{
		...
		$school_id = $row_attendance['school_id'];
		...
		<td><a href='delete.php?del_id=$v_id&s_id=$school_id&salesman_id=$salesman_id'><img src='img/del.png' style='width:25px; margin:auto;'></a></td>
		<td>$n</td>
		<td>$date</td>
		<td>$time</td>
		<td>$day</td>
...
<head>
    ...
    <title>School Visit Report - Good Luck Sales - Digigoodluck.com</title>
			...
			<div class="row sub" style="margin-top:2%;">
				<div class="col-sm-12 horizontal-scroll">
					<table id="school_list" class="table table-hover table-striped table-bordered table-responsive w-100 d-block d-md-table" style="width:100%;">
						...
						$get_attendance="select * from visits where user_name ='$salesman' AND school_state = '$state' and school_city='$city' and school_name='$school' and date BETWEEN '$start_date' AND '$end_date'order by date DESC, id DESC";
						...
						$get_attendance="select * from visits where user_name ='$salesman' AND school_state = '$state' and school_city='$city' and school_name='$school' order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where user_name ='$salesman' AND school_state = '$state' and school_name='$school' and date BETWEEN '$start_date' AND '$end_date'order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where user_name ='$salesman' AND school_state = '$state' and school_name='$school' order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where school_city ='$city' AND school_state = '$state' and user_name='$salesman' and date BETWEEN '$start_date' AND '$end_date'order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where school_city ='$city' AND school_state = '$state' and user_name='$salesman' order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where school_city ='$city' AND school_state = '$state' and school_name='$school' and date BETWEEN '$start_date' AND '$end_date'order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where school_city ='$city' AND school_state = '$state' and school_name='$school' order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where school_state = '$state' AND school_city='$city' order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where school_name ='$school' AND school_state = '$state' and date BETWEEN '$start_date' AND '$end_date'order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where school_name ='$school' AND school_state = '$state' order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where user_name ='$salesman' AND school_state = '$state'  and date BETWEEN '$start_date' AND '$end_date'order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where user_name ='$salesman' AND school_state = '$state' order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where school_state = '$state' order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
						...
						$get_attendance="select * from visits where date BETWEEN '$start_date' AND '$end_date' order by date DESC, id DESC";
						$run_attendance= mysqli_query($conn, $get_attendance);
