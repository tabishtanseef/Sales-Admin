...
if (isset($_POST['signup'])) {
	...
	$g = "SELECT email FROM admin WHERE email ='$email'";
	...
	if (!$error) {
		...
		if(mysqli_query($conn, "INSERT INTO admin(name, email, num, password) VALUES('" . $name . "', '" . $email . "', '" . $num . "', '" . md5($password) . "')")) {
...
<meta name="description" content="Progress Button Styles: Creative effects for loading buttons" />
		...
		<title>Register - Good Luck Sales - Digigoodluck.com</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
	<a class="navbar-brand" href="#">
		<img src="img/sales.png" width="120px" height="" alt="">
	  </a>
</nav>
<br>
<br>
