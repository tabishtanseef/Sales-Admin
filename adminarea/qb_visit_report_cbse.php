...
<head>
    ...
    <title>CBSE QB Visit Report - Good Luck Sales - Digigoodluck.com</title>
			...
			<div class="row sub" style="margin-top:2%;">
				<div class="col-sm-12 horizontal-scroll">
					<table id="school_list2" class="table table-hover table-striped table-bordered table-responsive w-100 d-block d-md-table" style="width:100%;">
						...
						$sql="select * from qb_school_list where user_id ='$salesman_id' and school_board='CBSE'";
						...
						while($i < $new){
							$sql1 = "select * from qb_visit WHERE city ='$users_arr[$i]' and user_id='$salesman_id' and board='CBSE'" ;
